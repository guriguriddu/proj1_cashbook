...
★ 금액 추출 규칙:
  한 항목에 취소선(strikethrough) 금액과 일반 금액이 함께 있으면 → 취소선 없는 최종 금액만 사용.
  예) "-4,000  -735원" 에서 -4,000에 취소선 있으면 → 금액: 735

★ 제외 강화:
  카카오페이/네이버페이/토스 등 간편결제로 나가는 실제 결제는 포함.
  단, 카카오페이 충전·머니 충전·증권 이체·포인트 충전처럼 내 계좌/지갑 간 이동은 제외.
  예) "카카오페이 충전 | KB국민→카카오페이증권" → 제외, "내 카카오페이→카카오페이증권" → 제외
