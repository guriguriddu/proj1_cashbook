...
중요: "내 계좌 → PAYCO결제", "내 계좌 → 카카오페이결제", "내 계좌 → 네이버페이결제", "내 계좌 → 토스결제" 등 간편결제 서비스로의 이체는 실제 소비 지출입니다. 반드시 포함하고 카테고리는 other로 분류해주세요.
제외 대상: 계좌 간 단순 이동(예: 내 하나계좌 → 내 신한계좌), 월급/급여 입금, 투자/저축 이체`,
            },
            {
              inline_data: {
