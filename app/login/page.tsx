...
function detectInAppBrowser(): boolean {
  ...
  return /naver|kakaotalk|instagram|fban|fbav|line\/|twitter\/|wv\b/.test(ua);
}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (navigator.clipboard) {
                    ...
                    alert('주소가 복사되었습니다. Chrome/Safari에 붙여넣기 해주세요.\n\n' + url);
                  } else {
                    alert('Chrome/Safari에서 아래 주소로 접속해주세요:\n\n' + url);
                  }
                }}
                style={{
                  width: '100%',
